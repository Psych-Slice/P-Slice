...
class DiscordClient
{
	...
	private static final _defaultID:String = "1272667686081527838";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = 'Engine Version: ${states.MainMenuState.pSliceVersion} (${MainMenuState.psychEngineVersion})';
