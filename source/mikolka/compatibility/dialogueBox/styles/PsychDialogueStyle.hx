...
import mikolka.compatibility.dialogueBox.styles.DialogueStyle.DialogueBoxState;
import mikolka.compatibility.dialogueBox.styles.DialogueStyle.DialogueBoxPosition;
