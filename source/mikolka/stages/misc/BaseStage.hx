...
class BaseStage extends FlxBasic
{
	...
	// overrides
	function startCountdown() if(onPlayState)  PlayState.instance.startCountdown();
	function endSong() if(onPlayState) PlayState.instance.endSong();
	...
	inline private function get_songName() return Paths.formatToSongPath(PlayState.SONG.song);
