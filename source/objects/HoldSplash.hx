...
class HoldSplash extends FlxSprite {
  ...
  public function new():Void {
    ...
    frames = Paths.getSparrowAtlas('holdCover/holdCover');
  ...
  public function setupSusSplash(strum:StrumNote, daNote:Note, ?playbackRate:Float = 1):Void {
    ...
    final timeThingy:Float = (125 * lengthToGet + (timeToGet - Conductor.songPosition + ClientPrefs.data.ratingOffset)) / playbackRate * .001;
